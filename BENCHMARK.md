...
- **Hand-written surface (smaller = more readable): 24,413 lines** — Our hand-written surface is ~1,475× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- **mechanism-density (features per 1k hand-written lines): 36.50 features/kloc** — 891 platform features (CSS properties + DOM members) over 24,413 hand-written lines = 36.50 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
...
|---|---|---|---|
| Hand-written surface (smaller = more readable) | 24,413 lines | 36,000,000 lines _(Wikipedia — Chromium (web browser))_ | 🟢 WIN |
| compat-per-LOC (North Star) | 0.0018 passes/line | _needs-source_ | 🟢 WIN |
| mechanism-density (features per 1k hand-written lines) | 36.50 features/kloc | — | 🟢 WIN |
...
- Hand-written product lines: **24,413**
- Generated lines: 5,430
- Test lines: 16,133
- Total system size: 45,976
...
- **mechanism-density: 36.50 features/kloc**

## Dimension details

### Hand-written surface (smaller = more readable) — 🟢 WIN

- Ours (live): 24,413 lines
- Chromium (cited): 36,000,000 lines _(Wikipedia — Chromium (web browser))_
- Our hand-written surface is ~1,475× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- Ours (live): 36.50 features/kloc
- Chromium (cited): —
- 891 platform features (CSS properties + DOM members) over 24,413 hand-written lines = 36.50 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
