...
- **Hand-written surface (smaller = more readable): 46,921 lines** — Our hand-written surface is ~767× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- **mechanism-density (features per 1k hand-written lines): 19.01 features/kloc** — 892 platform features (CSS properties + DOM members) over 46,921 hand-written lines = 19.01 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
...
|---|---|---|---|
| Hand-written surface (smaller = more readable) | 46,921 lines | 36,000,000 lines _(Wikipedia — Chromium (web browser))_ | 🟢 WIN |
| compat-per-LOC (North Star) | 0.0010 passes/line | _needs-source_ | 🟢 WIN |
| mechanism-density (features per 1k hand-written lines) | 19.01 features/kloc | — | 🟢 WIN |
| CSS-property coverage (raw count) | 340 properties | 600 properties _(CSS specifications (order-of-magnitude))_ | 🟡 GAP |
| Raw WPT / Interop pass rate | 100% of maintained WPT subsets (367/367 curated subtests) | 95% _(WebKit blog — The success of Interop 2024)_ | 🟡 GAP |
| Runtime performance (Speedometer-class) | not measured | _needs-source_ | ⚪ N/C |

## Our live metrics (re-computed every run)

- Hand-written product lines: **46,921**
- Generated lines: 5,439
- Test lines: 25,890
- Total system size: 78,250
...
- **mechanism-density: 19.01 features/kloc**

## Execution evidence (maintained WPT subset trace)

- Maintained subsets traced: 4
- WPT files/subtests: 103 files, 367 subtests
- WPT outcomes: 367 passed, 0 failed, 0 errored
- Query calls: 11795
- Recomputation events: 4166
- Cache hits: 7629
- Verified cache hits: 23
- Dependency reads: 127150
...
- Ours (live): 46,921 lines
- Chromium (cited): 36,000,000 lines _(Wikipedia — Chromium (web browser))_
- Our hand-written surface is ~767× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- Ours (live): 19.01 features/kloc
- Chromium (cited): —
- 892 platform features (CSS properties + DOM members) over 46,921 hand-written lines = 19.01 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
...
- Ours (live): 100% of maintained WPT subsets (367/367 curated subtests)
