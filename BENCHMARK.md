...
- **Hand-written surface (smaller = more readable): 48,839 lines** — Our hand-written surface is ~737× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- **mechanism-density (features per 1k hand-written lines): 18.26 features/kloc** — 892 platform features (CSS properties + DOM members) over 48,839 hand-written lines = 18.26 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
...
|---|---|---|---|
| Hand-written surface (smaller = more readable) | 48,839 lines | 36,000,000 lines _(Wikipedia — Chromium (web browser))_ | 🟢 WIN |
| compat-per-LOC (North Star) | 0.0009 passes/line | _needs-source_ | 🟢 WIN |
| mechanism-density (features per 1k hand-written lines) | 18.26 features/kloc | — | 🟢 WIN |
...
- Hand-written product lines: **48,839**
- Generated lines: 5,439
- Test lines: 26,407
- Total system size: 80,685
...
- **mechanism-density: 18.26 features/kloc**
...
- Ours (live): 48,839 lines
- Chromium (cited): 36,000,000 lines _(Wikipedia — Chromium (web browser))_
- Our hand-written surface is ~737× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- Ours (live): 18.26 features/kloc
- Chromium (cited): —
- 892 platform features (CSS properties + DOM members) over 48,839 hand-written lines = 18.26 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
