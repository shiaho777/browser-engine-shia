...
- **Hand-written surface (smaller = more readable): 47,310 lines** — Our hand-written surface is ~761× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- **mechanism-density (features per 1k hand-written lines): 18.85 features/kloc** — 892 platform features (CSS properties + DOM members) over 47,310 hand-written lines = 18.85 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
...
|---|---|---|---|
| Hand-written surface (smaller = more readable) | 47,310 lines | 36,000,000 lines _(Wikipedia — Chromium (web browser))_ | 🟢 WIN |
| compat-per-LOC (North Star) | 0.0010 passes/line | _needs-source_ | 🟢 WIN |
| mechanism-density (features per 1k hand-written lines) | 18.85 features/kloc | — | 🟢 WIN |
...
- Hand-written product lines: **47,310**
- Generated lines: 5,439
- Test lines: 25,951
- Total system size: 78,700
...
- **mechanism-density: 18.85 features/kloc**
...
- Ours (live): 47,310 lines
- Chromium (cited): 36,000,000 lines _(Wikipedia — Chromium (web browser))_
- Our hand-written surface is ~761× smaller than Chromium's cited ~36,000,000 lines — one person can read it front to back. (Honest caveat: smaller surface buys readability, not feature parity.)
...
- Ours (live): 18.85 features/kloc
- Chromium (cited): —
- 892 platform features (CSS properties + DOM members) over 47,310 hand-written lines = 18.85 features / 1k lines. Platform-as-Data makes coverage grow per data row, not per hand-written line — the mechanism advantage Chromium's hand-rolled surface cannot match.
